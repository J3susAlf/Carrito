...
//Añadir un producto
const añadirProducto       = document.getElementById('productoAñadir')      //Nombre del producto
const añadirPrecio         = document.getElementById('precioAñadir')        //Precio del producto
const añadirContenido      = document.getElementById('contenidoAñadir')     //Contenido
const añadirClasificación  = document.getElementById('clasificacionAñadir') //Clasificación
const añadirImagen         = document.getElementById('imagenAñadir')        //Insertar imagen
const añadirExistencia     = document.getElementById('existenciaAñadir')    //Cantidad en existencia


document.getElementById("botonAñadir").addEventListener("click", function (event) {
    event.preventDefault()
    let productoAñadir      = añadirProducto.value
    let precioAñadir        = añadirPrecio.value
    let contenidoAñadir     = añadirContenido.value
    let clasificacionAñadir = añadirClasificación.value
    ...
    if (van == true) {
        productos.push({
            ...
            precio:         precioAñadir,
            contenido:      contenidoAñadir,
            clasificacion:  clasificacionAñadir,
            imagen:         imagenAñadir,
...
window.addEventListener("load", () => {
    ...
    for (let i = 0; i < productos.length; i++) {
        ...
        <p class="contenido"><span>Contenido: ${productos[i].contenido}ml</span></p>
        <p class="precio"><span>Precio: $${productos[i].precio}</span></p>
        Existencia: ${productos[i].existencia}<p></p></div></div>`
    }
})
